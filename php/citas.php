    ...
    <?php
        ...
        if($permiso){
            ...
            if(isset($_GET["busqueda"])){
                ...
                if($usu==='a'){
                    $busqueda=$conexion->prepare("select socio,usuario,telefono,descripcion,fecha,hora from socio s, servicio sv, citas c where c.socio=s.id and c.servicio=sv.id and (usuario like ? or descripcion like ? or fecha = ?)");
